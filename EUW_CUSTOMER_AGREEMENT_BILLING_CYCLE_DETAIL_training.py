...
if __name__ == "__main__":
    ...
    if os.path.exists(log_dir+"/EUW_CUSTOMER_AGREEMENT_BILLING_CYCLE_DETAIL_LOG.log"):
       os.remove(log_dir+"/EUW_CUSTOMER_AGREEMENT_BILLING_CYCLE_DETAIL_LOG.log")
...
# generate last 13 billing cycles
    ...
    billingcycle = billingcycle.withColumn('Billing9_End_Date',date_sub(F.col('Billing8_Start_Date'),1))
    billingcycle = billingcycle.withColumn('Billing9_Start_Date',date_sub(F.col('Billing9_End_Date'),29))
    billingcycle = billingcycle.withColumn('Billing10_End_Date',date_sub(F.col('Billing9_Start_Date'),1))
    billingcycle = billingcycle.withColumn('Billing10_Start_Date',date_sub(F.col('Billing10_End_Date'),29))
    billingcycle = billingcycle.withColumn('Billing11_End_Date',date_sub(F.col('Billing10_Start_Date'),1))
    billingcycle = billingcycle.withColumn('Billing11_Start_Date',date_sub(F.col('Billing11_End_Date'),29))
    billingcycle = billingcycle.withColumn('Billing12_End_Date',date_sub(F.col('Billing11_Start_Date'),1))
    billingcycle = billingcycle.withColumn('Billing12_Start_Date',date_sub(F.col('Billing12_End_Date'),29))
    billingcycle = billingcycle.withColumn('Billing13_End_Date',date_sub(F.col('Billing12_Start_Date'),1))
    billingcycle = billingcycle.withColumn('Billing13_Start_Date',date_sub(F.col('Billing13_End_Date'),29))                                 
    ...
    billingcycle = billingcycle.select('CONCAT_AGMNT_NO','CUSTOMER_ID','ACCOUNT_SEQ','AGREEMENT_SEQ','Billing1_Start_Date','Billing1_End_Date','Billing2_Start_Date','Billing2_End_Date', 'Billing3_End_Date', 'Billing3_Start_Date', 'Billing4_End_Date', 'Billing4_Start_Date', 'Billing5_End_Date', 'Billing5_Start_Date', 'Billing6_End_Date', 'Billing6_Start_Date', 'Billing7_End_Date', 'Billing7_Start_Date', 'Billing8_End_Date', 'Billing8_Start_Date', 'Billing9_End_Date', 'Billing9_Start_Date', 'Billing10_End_Date', 'Billing10_Start_Date', 'Billing11_End_Date', 'Billing11_Start_Date', 'Billing12_End_Date', 'Billing12_Start_Date', 'Billing13_End_Date', 'Billing13_Start_Date', 'Next_Billing_StartDate','Next_Billing_EndDate')
    fileLog("generated bc1 till bc14 for prediction")
